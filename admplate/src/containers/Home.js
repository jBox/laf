                    ...
                    <div className="card shadow mb-4">
                        ...
                        <div className="card-body">
                            ...
                            <div className="mt-4 text-center small">
                                ...
                                <span className="mr-2">
                                    <i className="fas fa-circle text-info"></i> Referral</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="col-lg-6 mb-4">
                            <div className="card bg-primary text-white shadow">
                                <div className="card-body">Primary<div className="text-white-50 small">#4e73df</div>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6 mb-4">
                    ...
                    <div className="card shadow mb-4">
                        ...
                        <div className="card-body">
                            <div className="text-center">
                                <img className="img-fluid px-3 px-sm-4 mt-3 mb-4" style={{"width": "25rem;"}} src="/static/sb-admin-2/img/undraw_posting_photo.svg" alt="" />
                            </div>
